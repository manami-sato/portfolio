		...
		div.graphic
			div(v-if="getSortNum == 0||getSortNum == 2")
				section.businessCard
					div.graphic__img
						img(:src="`${path}img/graphic_02_meishi_2_1.png`",alt="2年後期名刺表")
						img(:src="`${path}img/graphic_02_meishi_2_2.png`",alt="2年後期名刺裏")
					div.graphic__info
						div
							h3.graphic__info--ttl 名刺
							div.graphic__info--sort 2年後期
						div.graphic__info--tool 使用ツール：Illustrator
						div.graphic__info--txt ポートフォリオのデザインに合わせて名刺を制作しました。
				div.businessCards
					section
						div.graphic__img
							img(:src="`${path}img/graphic_02_meishi_1_1.png`",alt="2年前期名刺表")
							img(:src="`${path}img/graphic_02_meishi_1_2.png`",alt="2年前期名刺裏")
						div.graphic__info
							div
								h3.graphic__info--ttl 名刺
								div.graphic__info--sort 2年前期
							div.graphic__info--tool 使用ツール：Illustrator／Photoshop
							div.graphic__info--txt 趣味で撮影した写真を利用して名刺を制作しました。
					section
						div.graphic__img
